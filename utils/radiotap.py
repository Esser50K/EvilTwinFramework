...
class RadioTapTSFTField(RadioTapField):
    ...
    def is_applicable(self, pkt):
        ...
        if (pkt.present != None) and (pkt.present & 0x1 == 0x1):
            return 1
        return 0

    def i2h(self,pkt,x):
        if (x == None) or (pkt.present == None):
            return 0
...
class RadioTapFlagsField(RadioTapByteField):
    def is_applicable(self, pkt):
        if (pkt.present != None) and ( pkt.present & 0x2 == 0x2 ):
            return 1
        return 0
...
class RadioTapRateField(RadioTapByteField):
    def is_applicable(self, pkt):
        if (pkt.present != None) and ( pkt.present & 0x4 == 0x4 ):
            return 1
        return 0
...
class RadioTapChannelField(RadioTapField):
    ...
    def is_applicable(self, pkt):
        if ( pkt.present != None ) and ( pkt.present & 0x8 == 0x8 ):
                return 1
        return 0
...
class RadioTapFHSSField(RadioTapField):
    ...
    def is_applicable(self, pkt):
        if ( pkt.present != None ) and ( pkt.present & 0x10 == 0x10 ):
            return 1
        return 0
...
class RadioTapAntennaSignalField(SignedByteField):
    def is_applicable(self, pkt):
        if ( pkt.present != None ) and ( pkt.present & 0x20 == 0x20 ):
            return 1
        return 0
...
class RadioTapAntennaNoiseField(SignedByteField):
    def is_applicable(self, pkt):
        if ( pkt.present != None ) and ( pkt.present & 0x40 == 0x40 ):
            return 1
        return 0
...
class RadioTapLockQualityField(RadioTapField):
    def __init__(self,name,default):
        Field.__init__(self,name,default,"2s")
    def is_applicable(self, pkt):
        if ( pkt.present != None ) and ( pkt.present & 0x80 == 0x80 ):
            return 1
        return 0
